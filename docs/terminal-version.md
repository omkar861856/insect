...
[npm](https://www.npmjs.com/package/ecocalculator):

    npm install -g ecocalculator
...
package](https://aur.archlinux.org/packages/ecocalculator/):

    yaourt -S ecocalculator

For macOS, there is a [Homebrew formula](https://formulae.brew.sh/formula/ecocalculator):

    brew install ecocalculator

For Android, install [Termux](https://termux.com/) from [F-Droid](https://f-droid.org/packages/com.termux/). Install Node.js in Termux and then install `ecocalculator` from npm:
